...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	hours := r.Duration.Minutes()
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * hours)
}
...
type Walking struct {
	// добавьте необходимые поля в структуру
	Training         // Встраиваем структуру Training
...
func (w Walking) Calories() float64 {
	...
	hours := w.Duration.Minutes()
	speedInMsec := w.meanSpeed() * KmHInMsec
	return ((CaloriesWeightMultiplier*w.Weight + (speedInMsec*speedInMsec/heightInMeters)*CaloriesSpeedHeightMultiplier*w.Weight) * hours)
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return (s.LengthPool * float64(s.CountPool)) / MInKm / s.Duration.Minutes() * MinInHours
}
...
func (s Swimming) Calories() float64 {
	...
	return (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * hours
}
